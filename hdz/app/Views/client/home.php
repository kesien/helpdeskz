...
<div class="slider-block">
    <div class="slider-content">
        <div class="container">
            ...
            <h1>
                <?php echo lang('Client.kb.howCanWeHelpYou'); ?>
            </h1>
...
<div class="container mt-5">
    ...
    <?php else: ?>
        <div class="mb-5">
            <a class="inactive_link" href="<?php echo site_url(); ?>"><?php echo lang('Client.kb.title'); ?>
                &nbsp;
                /</a>
            <?php
                    ...
                    <?php foreach ($categories as $item): ?>
                        ...
                        <?php if ($total_articles > 0): ?>
                            <div class="col-lg-6 mt-4">
                                <div class="pt-2">
                                    <a class="kb_category"
                                        href="<?php echo site_url(route_to('category', $item->id, url_title($item->name))); ?>">
                                ...
                                <?php foreach (kb_articles_category($item->id) as $article): ?>
                                    <div class="py-2">
                                        ...
                                        <a
                                            href="<?php echo site_url(route_to('article', $article->id, url_title($article->title))); ?>">
                            ...
                            <div class="float-left">
                                ...
                                <div class="mb-1">
                                    <a class="font-weight-bold"
                                        href="<?php echo site_url(route_to('article', $item->id, url_title($item->title))); ?>">
                                        <?php echo $item->title; ?>
                                    </a>
                                </div>
        ...
        <div class="col">
            <div class="pl-3 pt-3">
                <?php if ($article_list = kb_popular()): ?>
                    <div class="mb-5">
                        <h4 class="mb-4">
                            <?php echo lang('Client.kb.mostPopular'); ?>
                        </h4>
                ...
                <?php if ($article_list = kb_newest()): ?>
                    <h4 class="mb-4">
                        <?php echo lang('Client.kb.newest'); ?>
                    </h4>
                    <?php foreach ($article_list as $item): ?>
                        <div class="mb-3">
                            <i class="fa fa-file-text-o kb_article_icon pr-3"></i>
