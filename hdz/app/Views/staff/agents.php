    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col text-md-right">
                <a href="<?php echo site_url(route_to('staff_agents_new')); ?>" class="btn btn-primary btn-sm"><i
                        class="fa fa-plus"></i>
                    <?php echo lang('Admin.agents.new'); ?>
                </a>
            </div>
        </div>
        ...
        <table class="table table-striped table-hover">
            <thead class="titles">
                <tr>
                    ...
                    <th>
                        <?php echo lang('Admin.agents.registration'); ?>
                    </th>
                    <th>
                        <?php echo lang('Admin.agents.lastLogin'); ?>
                    </th>
                    <th>
            ...
            foreach ($agents_list as $agent) {
                ...
                <tr>
                    <td>
                        ...
                        <small>
                            <?php echo ($agent->admin == 1 ? '<span class="text-danger">' . lang('Admin.agents.administrator') . '</span>' : ($agent->admin == 2 ? lang('Admin.agents.user') : lang('Admin.agents.agent'))); ?>
                        </small>
                    </td>
                    <td>
                    ...
                    <td>
                        <?php echo time_ago($agent->registration); ?>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        if ($agent->id != staff_data('id')) {
                            ?>
                            <div class="btn-group">
                                <a href="<?php echo site_url(route_to('staff_agents_edit', $agent->id)); ?>"
                                    class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                <button type="button" onclick="removeAgent(<?php echo $agent->id; ?>)"
