            ...
            <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
                <div class="main-navbar">
                    <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
                        <a class="navbar-brand w-100 mr-0" href="<?php echo site_url(route_to('staff_tickets')); ?>"
                ...
                <div class="input-group input-group-seamless ml-3">
                    ...
                    <input name="keyword" class="navbar-search form-control" type="text"
                        placeholder="<?php echo lang('Admin.form.searchTicket'); ?>..." aria-label="Search">
                </div>
                <?php
                echo form_close();
                ?>
                <div class="nav-wrapper">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link <?php echo (uri_page() == 'tickets' ? 'active' : ''); ?>"
                                href="<?php echo site_url(route_to('staff_tickets')); ?>">
                        ...
                        if (staff_data('admin') == 1) {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo (uri_page() == 'departments' ? 'active' : ''); ?>"
                                    href="<?php echo site_url(route_to('staff_departments')); ?>">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo (uri_page() == 'users' ? 'active' : ''); ?>"
                                    href="<?php echo site_url(route_to('staff_users')); ?>">
                                    <i class="fas fa-users"></i>
                                    <span>
                                        <?php echo lang('Admin.users.menu'); ?>
                                    </span>
                                </a>
                            </li>

                            <li class="nav-item dropdown <?php echo (uri_page() == 'tools' ? 'show' : ''); ?>">
                                <a class="nav-link dropdown-toggle <?php echo (uri_page() == 'tools' ? 'active' : ''); ?>"
                                    data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="true">
                                    <i class="fa fa-tools"></i>
                                    <span>
                                        <?php echo lang('Admin.tools.menu'); ?>
                                    </span>
                                </a>
                                <div
                            ...
                            <li class="nav-item dropdown <?php echo (uri_page() == 'setup' ? 'show' : ''); ?>">
                                <a class="nav-link dropdown-toggle <?php echo (uri_page() == 'setup' ? 'active' : ''); ?>"
                                    data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="true">
                                    <i class="fa fa-cogs"></i>
                                    <span>
                                        <?php echo lang('Admin.settings.menu'); ?>
                                    </span>
                                </a>
                                <div
                ...
                <div class="main-navbar sticky-top bg-white">
                    ...
                    <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
                        ...
                        <div class="input-group input-group-seamless ml-3">
                            ...
                            <input class="navbar-search form-control" name="keyword" type="text"
                                placeholder="<?php echo lang('Admin.form.searchTicket'); ?>..." aria-label="Search">
                        </div>
                        <?php
                        echo form_close();
                        ...
                        <ul class="navbar-nav border-left flex-row ">
                            <li class="nav-item border-right">
                                <div class="text-nowrap px-3 pt-3">
                                    <a href="<?php echo site_url(route_to('staff_ticket_new')); ?>"
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#"
                                    ...
                                    <img class="user-avatar rounded-circle mr-2"
                                        src="<?php echo staff_avatar(staff_data('avatar')); ?>" alt="User Avatar">
                                    <span class="d-none d-md-inline-block">
                                        <?php echo staff_data('fullname'); ?>
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-small">
                                    <a class="dropdown-item" href="<?php echo site_url(route_to('staff_profile')); ?>">
                                        <i class="fas fa-user-cog"></i>
                                        <?php echo lang('Admin.account.profile'); ?>
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item text-danger"
                                        href="<?php echo site_url(route_to('staff_logout')); ?>">
                                        <i class="fas fa-sign-out-alt text-danger"></i>
                                        <?php echo lang('Admin.account.logout'); ?>
                                    </a>
