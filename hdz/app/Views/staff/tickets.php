...
<div class="mb-3">
    <a href="<?php echo site_url(route_to('staff_tickets')); ?>"
        class="btn <?php echo ($page_type == 'main' ? 'btn-primary' : 'btn-outline-primary'); ?>">
        <?php echo lang('Admin.tickets.active'); ?> (
        <?php echo count_status('active'); ?>)
    </a>
    <a href="<?php echo site_url(route_to('staff_tickets_overdue')); ?>"
        class="btn <?php echo ($page_type == 'overdue' ? 'btn-primary' : 'btn-outline-primary'); ?>">
        <?php echo lang('Admin.form.overdue'); ?> (
        <?php echo count_status('overdue'); ?>)
    </a>
    <a href="<?php echo site_url(route_to('staff_tickets_answered')); ?>"
        class="btn <?php echo ($page_type == 'answered' ? 'btn-primary' : 'btn-outline-primary'); ?>">
        <?php echo lang('Admin.form.answered'); ?> (
        <?php echo count_status('answered'); ?>)
    </a>
    <a href="<?php echo site_url(route_to('staff_tickets_closed')); ?>"
        class="btn <?php echo ($page_type == 'closed' ? 'btn-primary' : 'btn-outline-primary'); ?>">
        <?php echo lang('Admin.form.closed'); ?> (
        <?php echo count_status('closed'); ?>)
    </a>
</div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label>
                        <?php echo lang('Admin.form.keyword'); ?>
                    </label>
                    <?php
                    echo form_input([
                        'name' => 'keyword',
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>
                        <?php echo lang('Admin.form.dateOpened'); ?>
                    </label>
                    <?php
                    echo form_input([
                        'name' => 'date_created',
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>
                        <?php echo lang('Admin.form.lastUpdate'); ?>
                    </label>
                    <?php
                    echo form_input([
                        'name' => 'last_update',
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="agent" class="form-control custom-select">
                        <option value="">-------------------</option>
                        <?php
                        log_message('error', json_encode($agents));
        ...
        <div class="form-group">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="1" id="overdueTickets" name="overdue" <?php echo ($request->getGet('overdue') == '1' ? 'checked' : ''); ?> <label class="form-check-label"
                    for="overdueTickets">
        ...
        <table class="table table-hover table-striped">
            <thead>
                <tr>
                    ...
                    <th>
                        <?php echo sort_link('subject', lang('Admin.form.subject')); ?>
                    </th>
                    <th>
                        <?php echo sort_link('last_reply', lang('Admin.form.lastReply')); ?></a>
                    </th>
                    <th>
                    ...
                    <th>
                        <?php echo sort_link('status', lang('Admin.form.status')); ?>
                    </th>
                </tr>
            </thead>
...
<div id="ticket_options" style="margin-top:20px; display:none;">
    <div class="card">
        <div class="card-header">
            <?php echo lang('Admin.form.massAction'); ?>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select name="department" class="custom-select">
                            <option value="">
                                <?php echo lang('Admin.form.noChange'); ?>
                            </option>
                            <?php
                            if ($departments) {
            ...
            <div class="form-group">
                ...
                <button id="trash_button" type="button" class="m-0 btn btn-danger"><i class="fa fa-trash"></i>
