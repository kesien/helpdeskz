...
('staff_ticketnotification', 6, 'New ticket notification to staff', 'New ticket notification', '<p>Dear %staff_name%,</p>\r\n<p>A new ticket has been created in department assigned for you, please login to staff panel to answer it.</p>\r\n<p>Ticket Details<br />-------------------<br />Ticket ID: %ticket_id% <br />Department: %ticket_department% <br />Status: %ticket_status% <br />Priority: %ticket_priority% <br />Helpdesk: %support_url%</p>\r\n<p>Original message:</p>\r\n<p>%original_message%</p>', 0, 0),
('send_copy_to', 7, 'Send copy to', 'New ticket notification', '<p>Dear %email%,</p>\r\n<p>This is a notification to inform you about a new ticket created. Please review and address it promptly.</p>\r\n<p>Ticket Details<br />-------------------<br />Ticket ID: %ticket_id% <br />Department: %ticket_department% <br />Status: %ticket_status% <br />Priority: %ticket_priority% <br />Helpdesk: %support_url%</p>\r\n<p>Original message:</p>\r\n<p>%original_message%</p>', 0, 2),
('message_added_to_ticket_notification', 8, 'Message added to ticket notification', '[#%ticket_id%]: A new message has been added', '<p>%message%</p>\r\n<p>Ticket Details<br />-------------------<br />Ticket ID: %ticket_id% <br />Department: %ticket_department% <br />Status: %ticket_status% <br />Priority: %ticket_priority% <br />Helpdesk: %support_url%</p>\r\n<p>Original message:</p>\r\n<p>%original_message%</p>', 0, 2);
